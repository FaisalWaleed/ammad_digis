...
RSpec.describe Admin::PatientsController, type: :controller do
  ...
  # Admin::PatientsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested admin_patient as @admin_patient" do
      ...
      expect(assigns(:admin_patient)).to eq(patient)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_patient as @admin_patient" do
      ...
      expect(assigns(:admin_patient)).to be_a_new(Patient)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Patient" do
        expect {
          post :create, {:admin_patient => valid_attributes}, valid_session
        }.to change(Patient, :count).by(1)
      end

      it "assigns a newly created admin_patient as @admin_patient" do
        post :create, {:admin_patient => valid_attributes}, valid_session
        expect(assigns(:admin_patient)).to be_a(Patient)
        expect(assigns(:admin_patient)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved admin_patient as @admin_patient" do
        post :create, {:admin_patient => invalid_attributes}, valid_session
        expect(assigns(:admin_patient)).to be_a_new(Patient)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_patient" do
        patient = Patient.create! valid_attributes
        put :update, {:id => patient.to_param, :admin_patient => new_attributes}, valid_session
        patient.reload
      ...
      it "assigns the requested admin_patient as @admin_patient" do
        patient = Patient.create! valid_attributes
        put :update, {:id => patient.to_param, :admin_patient => valid_attributes}, valid_session
        expect(assigns(:admin_patient)).to eq(patient)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_patient as @admin_patient" do
        patient = Patient.create! valid_attributes
        put :update, {:id => patient.to_param, :admin_patient => invalid_attributes}, valid_session
        expect(assigns(:admin_patient)).to eq(patient)
      end
