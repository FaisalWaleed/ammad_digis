...
RSpec.describe "admin/pharmacies/edit", type: :view do
  before(:each) do
    @admin_pharmacy = assign(:admin_pharmacy, Pharmacy.create!(
  ...
  it "renders the edit admin_pharmacy form" do
    render

    assert_select "form[action=?][method=?]", admin_pharmacy_path(@admin_pharmacy), "post" do
