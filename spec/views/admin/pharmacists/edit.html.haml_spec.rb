...
RSpec.describe "admin/pharmacists/edit", type: :view do
  before(:each) do
    @admin_pharmacist = assign(:admin_pharmacist, Pharmacist.create!(
      :firstname => "MyString",
      :middlename => "MyString",
      :lastname => "MyString",
      :gender_id => "MyString",
  ...
  it "renders the edit admin_pharmacist form" do
    render

    assert_select "form[action=?][method=?]", admin_pharmacist_path(@admin_pharmacist), "post" do
