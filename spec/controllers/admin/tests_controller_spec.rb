...
RSpec.describe Admin::TestsController, type: :controller do
  ...
  # Admin::TestsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested admin_test as @admin_test" do
      ...
      expect(assigns(:admin_test)).to eq(test)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_test as @admin_test" do
      ...
      expect(assigns(:admin_test)).to be_a_new(Test)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Test" do
        expect {
          post :create, {:admin_test => valid_attributes}, valid_session
        }.to change(Test, :count).by(1)
      end

      it "assigns a newly created admin_test as @admin_test" do
        post :create, {:admin_test => valid_attributes}, valid_session
        expect(assigns(:admin_test)).to be_a(Test)
        expect(assigns(:admin_test)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved admin_test as @admin_test" do
        post :create, {:admin_test => invalid_attributes}, valid_session
        expect(assigns(:admin_test)).to be_a_new(Test)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_test" do
        test = Test.create! valid_attributes
        put :update, {:id => test.to_param, :admin_test => new_attributes}, valid_session
        test.reload
      ...
      it "assigns the requested admin_test as @admin_test" do
        test = Test.create! valid_attributes
        put :update, {:id => test.to_param, :admin_test => valid_attributes}, valid_session
        expect(assigns(:admin_test)).to eq(test)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_test as @admin_test" do
        test = Test.create! valid_attributes
        put :update, {:id => test.to_param, :admin_test => invalid_attributes}, valid_session
        expect(assigns(:admin_test)).to eq(test)
      end
