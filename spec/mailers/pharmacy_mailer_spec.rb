...
RSpec.describe PharmacyMailer, type: :mailer do
  describe "activation_instructions" do
    let(:mail) { PharmacyMailer.activation_instructions }
  ...
  describe "activation_welcome" do
    let(:mail) { PharmacyMailer.activation_welcome }
  ...
  describe "password_recovery_instructions" do
    let(:mail) { PharmacyMailer.password_recovery_instructions }
  ...
  describe "password_recovery_success" do
    let(:mail) { PharmacyMailer.password_recovery_success }
  ...
  describe "password_recovery_fail" do
    let(:mail) { PharmacyMailer.password_recovery_fail }
