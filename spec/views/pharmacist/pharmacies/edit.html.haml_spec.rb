...
RSpec.describe "pharmacist/pharmacies/edit", type: :view do
  before(:each) do
    @pharmacist_pharmacy = assign(:pharmacist_pharmacy, Pharmacy.create!(
      :name => "MyString",
  ...
  it "renders the edit pharmacist_pharmacy form" do
    render

    assert_select "form[action=?][method=?]", pharmacist_pharmacy_path(@pharmacist_pharmacy), "post" do
