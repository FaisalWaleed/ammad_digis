...
RSpec.describe "physician/patients/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit physician_patient form" do
    render

    assert_select "form[action=?][method=?]", physician_patient_path(@physician_patient), "post" do
