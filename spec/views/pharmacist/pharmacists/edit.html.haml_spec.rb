...
RSpec.describe "pharmacist/pharmacists/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit pharmacist_pharmacist form" do
    render

    assert_select "form[action=?][method=?]", pharmacist_pharmacist_path(@pharmacist_pharmacist), "post" do
