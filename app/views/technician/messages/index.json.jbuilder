json.array! @conversations do |conversation|
  ...
  json.message_count(conversation.messages_for_technician.length)
  json.unread_message_count(conversation.messages_for_technician.unread.length)
  ...
  json.url(technician_message_path(conversation, type: conversation.class.name.parameterize))
  json.asset_type('technician')
